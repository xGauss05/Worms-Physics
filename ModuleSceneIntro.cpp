...
bool ModuleSceneIntro::Start()
{
	...
	ground11 = new Body(PIXEL_TO_METERS(85), PIXEL_TO_METERS(100), RECTANGLE, PIXEL_TO_METERS(150), PIXEL_TO_METERS(50), STATIC, EntityType::WALL, 1.0f, 20.0f, 20.0f);
	App->physics->world->AddBody(ground11);

	ground12 = new Body(PIXEL_TO_METERS(85), PIXEL_TO_METERS(150), RECTANGLE, PIXEL_TO_METERS(50), PIXEL_TO_METERS(50), STATIC, EntityType::WALL, 1.0f, 20.0f, 20.0f);
	App->physics->world->AddBody(ground12);

	ground13 = new Body(PIXEL_TO_METERS(185), PIXEL_TO_METERS(150), RECTANGLE, PIXEL_TO_METERS(50), PIXEL_TO_METERS(50), STATIC, EntityType::WALL, 1.0f, 20.0f, 20.0f);
